...
public class UploadActivity extends AppCompatActivity {
    ...
    Button saveButton;
    EditText uploadTitle, uploadContent, uploadType;
    String imageURL;
    Uri uri;
    ...
    private void uploadData() {
        ...
        // 创建 DataClass 对象时确保参数的顺序是正确的
        DataClass dataClass = new DataClass(title, content, type, imageURL);
        ...
        FirebaseDatabase.getInstance().getReference("Android Tutorials").child(title).setValue(dataClass).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(UploadActivity.this,"儲存",Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
