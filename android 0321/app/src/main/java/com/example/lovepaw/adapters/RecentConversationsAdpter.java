...
import com.example.lovepaw.databinding.ItemContainerConversionBinding;
...
public class RecentConversationsAdpter extends RecyclerView.Adapter<RecentConversationsAdpter.ConversionViewHolder>{

    private final List<ChatMessage> chatMessages;
    private final ConversionListener conversionListener;

    public RecentConversationsAdpter(List<ChatMessage> chatMessages,ConversionListener conversionListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecentConversationsAdpter.ConversionViewHolder holder, int position) {
